    ...
    >
      ...
      <div className="mx-auto flex w-[calc(100%-2.5rem)] max-w-[1216px] flex-col justify-between gap-8 py-10 sm:w-[calc(100%-5rem)] sm:flex-row sm:items-center sm:gap-8 sm:py-11 lg:py-[54px]">
        <div className="text-black">
          ...
          <a
            href="#contact"
            className="mt-5 inline-flex min-h-9 items-center gap-3 border-2 border-black px-4 py-3 text-sm font-bold uppercase tracking-wide transition-colors hover:bg-black md:text-base hover:text-white"
          >
            Contact us
        ...
        <div className="shrink-0 text-black lg:mr-4 xl:mr-8">
