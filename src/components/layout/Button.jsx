function Button({ children, className = '', href, variant = 'light', type = 'button', ...props }) {
  ...
  const classes = `inline-flex min-h-11 items-center justify-center gap-3 px-5 text-xs font-black uppercase tracking-tight transition-colors duration-200 ${styles[variant]} ${className}`
